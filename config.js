...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "IK~xaMV2RjJ#4uDOfeWdwCVQr8xS2y4kviAwEDQh9kv7HOt1IvV90qQ",  // Your bot's session ID (keep it secure)
    ...
    STICKER_NAME: process.env.STICKER_NAME || "FRANK",     // Sticker pack name
